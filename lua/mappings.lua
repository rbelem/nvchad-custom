...
-- marks
map("n", "<leader>mm", "<cmd> :lua require(\"marks\").toggle()<CR>", { desc = "Toggle mark" })
map("n", "<leader>ml", "<cmd> MarksListAll<CR>", { desc = "List marks" })
map("n", "<leader>m,", "<cmd> :lua require(\"marks\").set_next()<CR>", { desc = "Set next marks" })
map("n", "<leader>m;", "<cmd> :lua require(\"marks\").set()<CR>", { desc = "Set mark" })
map("n", "<leader>mn", "<cmd> :lua require(\"marks\").next()<CR>", { desc = "Next mark" })
map("n", "<leader>mp", "<cmd> :lua require(\"marks\").prev()<CR>", { desc = "Previous mark" })
map("n", "<leader>m:", "<cmd> :lua require(\"marks\").preview()<CR>", { desc = "Preview marks" })
map("n", "<leader>mbn", "<cmd> :lua require(\"marks\").next_bookmark()<CR>", { desc = "Next bookmark" })
map("n", "<leader>mbp", "<cmd> :lua require(\"marks\").prev_bookmark()<CR>", { desc = "Previous bookmark" })
map("n", "<leader>md", "<cmd> :lua require(\"marks\").delete()<CR>", { desc = "Delete mark" })
map("n", "<leader>mdd", "<cmd> :lua require(\"marks\").delete_line()<CR>", { desc = "Delete mark line" })
map("n", "<leader>mbd", "<cmd> :lua require(\"marks\").delete_bookmark()<CR>", { desc = "Delete bookmark" })
map("n", "<leader>mx", "<cmd> :lua require(\"marks\").delete_buf()<CR>", { desc = "Delete " })
